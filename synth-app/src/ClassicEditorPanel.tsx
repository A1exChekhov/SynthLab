...
export default function ClassicEditorPanel() {
      ...
      <div style={{ width: "100%" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            <button onClick={() => { alert("Кэш звука очищен!"); }} style={{ background: "transparent", border: "1px solid #d1d5da", color: "#586069", padding: "6px 12px", borderRadius: "4px", cursor: "pointer", fontSize: "12px", transition: "all 0.2s" }}>
              🧹 Очистить кэш
            </button>
          ...
          {activeGlobalTab === "custom" ? (
             Object.keys(customPresets).length === 0 ? (
               ...
               const renderNode = (name: string, node: any, path: string = "", depth: number = 0) => {
                 ...
                 // subgroups available via node.subgroups
